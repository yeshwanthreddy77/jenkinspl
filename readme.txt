 ...
 This will deploy two artifacts, target/projectweb.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/projectweb.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/projectweb.war

 To undeploy the application, run:

  ./asadmin undeploy projectweb
